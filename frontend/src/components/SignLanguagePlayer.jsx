...
//         preloadVideo(fullPaths[0]);
//         if (fullPaths.length > 1) {
//           preloadVideo(fullPaths[1]);
//         }
//       }
//     } catch (error) {
...
//     return `absolute inset-0 w-full h-full object-contain transition-opacity duration-300 ${
...
//     // Preload next videos when index changes
//     if (currentVideoIndex < videoPaths.length - 1) {
//       preloadVideo(videoPaths[currentVideoIndex + 1]);
//     }
//     if (currentVideoIndex < videoPaths.length - 2) {
//       preloadVideo(videoPaths[currentVideoIndex + 2]);
//     }
...
//       videoRefs.current[currentVideoIndex + 1].play().catch((err) => {
...
//               rows={4}
//               className="w-full px-6 py-4 border-2 border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 resize-none text-gray-800 dark:text-gray-200 bg-gray-50 dark:bg-gray-700 placeholder-gray-500 dark:placeholder-gray-400 text-lg"
//             />
...
//             {[currentVideoIndex, currentVideoIndex + 1].map((index) => {
...
//                   }
//                   onTimeUpdate={
//                     index === currentVideoIndex ? handleTimeUpdate : undefined
//                   }
//                   onWaiting={
//                     index === currentVideoIndex ? handleWaiting : undefined
//                   }
//                   onPlaying={
//                     index === currentVideoIndex ? handlePlaying : undefined
//                   }
//                   onError={() => {
//                     if (index === currentVideoIndex) {
//                       setError(`Failed to load video: ${videoPaths[index]}`);
//                       setIsPlaying(false);
//                       setBuffering(false);
//                     }
//                   }}
